...
#define ZEBRAGAME_SCORE_RANK_S (3000)
#define ZEBRAGAME_SCORE_RANK_A (2000)
#define ZEBRAGAME_SCORE_RANK_B (1000)
#define ZEBRAGAME_SCORE_RANK_C (0)
#define LIONGAME_SCORE_RANK_S (3000)
#define LIONGAME_SCORE_RANK_A (2000)
#define LIONGAME_SCORE_RANK_B (1000)
