...
{ 
	...
	//オブジェクトの生成(2Dポリゴン)
	pPlayer2D = CPlayer2D::Create( D3DXVECTOR3( 150.0f, 580.0f, 0.0f), D3DXVECTOR3( 300.0f, 300.0f, 0.0f));
	//ゴミ
	...
	//ゴミ箱
	m_pTrashBox = CScene2D::Create(D3DXVECTOR3(1000.0f, 500.0f, 0.0f), D3DXVECTOR3(800.0f, 500.0f, 0.0f),TEXTURE_TRASHBOX);
	//タイム
	pTime = CTime::Create(D3DXVECTOR3(600, 50.0f, 0.0f),D3DXVECTOR3(100, 100.0f, 0.0f),3,20,true,D3DXCOLOR(255,255,255,255));
	//マウスの位置を得る
